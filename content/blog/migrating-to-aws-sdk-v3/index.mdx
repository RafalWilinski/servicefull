...
In V3, there's only one option - asynchronous one. Moreover, it requires you to import `@aws-sdk/s3-request-presigner` package and call `getSignedUrl` on the Command object.
