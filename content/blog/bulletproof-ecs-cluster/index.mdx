...
That's why you want to scale you EC2 machines running your cluster based on Memory or CPU *reservations* instead of usage. Your *services* should scale based on usage and as the amount of them grows, the amount of reserved resources also which will effectively trigger AutoScaling group operation.
