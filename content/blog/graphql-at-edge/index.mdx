...
With CDK, provisioning something which might seem really complicated like this example, can actually with in less than 100 lines of code, here's complete infrastructure code proof of concept:
