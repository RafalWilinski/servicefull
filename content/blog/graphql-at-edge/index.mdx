...
With CDK, provisioning something which might seem really complicated like this example, can actually be done with less than 100 lines of code. Here's the complete infrastructure code proof of concept:
