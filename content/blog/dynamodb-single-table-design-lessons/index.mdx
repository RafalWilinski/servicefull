...
- You should always use `Limit` (more on that later), and probably you should also restrict that number to some upper bound like 1000. Something like `Math.max(params.limit, 1000)` could also be there
