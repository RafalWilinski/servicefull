---
title: Creating Golang functions in AWS CDK
...
The result of my work is here: [aws-lambda-golang-cdk on Github](https://github.com/RafalWilinski/aws-lambda-golang-cdk)

![AWS CDK Golang Construct](./aws-lambda-golang.png 'AWS CDK Golang Lambda Function Construct')

Usage of Golang construct in CDK is very simple:
