...
<ComparisonTable
  items={[
    { title: "Terraform",
      points: ["Written in HCL", "Declarative", "Supports multiple providers", "SDK calll under the hood", "Modules"]
    },
    { title: "CDK",
      points: ["Written in TS, Java or Python", "Imperative", "AWS Only", "Cloudformation under the hood", "Constructs"]
    }
  ]}
/>
