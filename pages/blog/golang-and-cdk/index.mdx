...
length: 2 minutes
excerpt: Go, known also as Golang, despite being the language of the cloud still is not having proper support in CDK (Cloud Development Kit). Over 500 programmers expressed the interest, however, it's not there yet. Don't get me wrong, I'm not…
---
